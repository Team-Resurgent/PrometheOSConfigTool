...
namespace PrometheOSConfigTool
{
    public class ImGuiController : IDisposable
    {
        ...
        {
            var fontData = ResourceLoader.GetEmbeddedResourceBytes("PrometheOSConfigTool.Resources.ARIALUNI.TTF", typeof(ImGuiController).GetTypeInfo().Assembly);
        ...
        {
            _splashTexture = CreateTextureFromResource("PrometheOSConfigTool.Resources.TeamResurgent.jpg");
        }
        ...
        public void CreateDeviceResources()
        {
            ...
            string VertexSource = ResourceLoader.GetEmbeddedResourceString("PrometheOSConfigTool.Resources.imgui-vertex.glsl");
            string FragmentSource = ResourceLoader.GetEmbeddedResourceString("PrometheOSConfigTool.Resources.imgui-frag.glsl");
